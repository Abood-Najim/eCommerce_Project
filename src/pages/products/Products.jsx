...
//   // UI State (Changes instantly when user clicks)
//   const [selectedCategory, setSelectedCategory] = useState(urlCategoryId || '')
//   const [minPrice, setMinPrice] = useState('')
//   const [maxPrice, setMaxPrice] = useState('')
//   const [selectedRating, setSelectedRating] = useState('')

//   // ACTUAL FILTER STATE (Only updates when "Apply Filters" is clicked)
...
//     // This is the magic: Only here do we copy the UI state into the actual filter state
...
//     setSelectedCategory('')
//     setAppliedCategory('') // Clears the actual filter
//     setMinPrice('')
//     setMaxPrice('')
//     setSelectedRating('')
//     navigate('/products')
...
//                 onChange={() => setSelectedCategory(String(category.id))} // Only updates UI state
//                 size="small"
//                 color="primary"
//                 sx={{ p: 0.5 }}
//               />
...
//           {/* THE FIX: Pass appliedCategory, NOT selectedCategory */}
//           <ProductsComponent 
//             page={page} 
//             limit={limit} 
//             sortBy={sortBy} 
...
export default function ProductsPage() {
  ...
  const [appliedCategory, setAppliedCategory] = useState(urlCategoryId || '')
  const [totalCount, setTotalCount] = useState(0) // <--- Trust the child!
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4 }}>
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          <ProductsComponent 
            ...
            ascending={ascending}
            categoryId={appliedCategory}
            onTotalCountChange={setTotalCount} // <--- Pass the setter down
          />
