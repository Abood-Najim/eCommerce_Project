            ...
            <Box sx={{ position: 'relative', zIndex: 1, maxWidth: 400 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                <Button
                  ...
                  variant="contained"
                  sx={{
                    px: 4, py: 1.2, borderRadius: 2, textTransform: 'none', fontWeight: 600, width: '100%', maxWidth: 300
                  }}
                  endIcon={
                    <ArrowForwardIcon sx={{ transform: i18n.language === 'ar' ? 'rotate(180deg)' : 'none' }} />
                  }
                >
                  {t('Shop Collection')}
                </Button>
            ...
            <Box sx={{ flex: 1, maxWidth: '100%' }}>
              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                <Button
                  ...
                  variant="contained"
                  sx={{
                    px: 4, py: 1.2, borderRadius: 2, textTransform: 'none', fontWeight: 600, width: '100%', maxWidth: 300, display: 'flex', gap: 1
                  }}
                  endIcon={
                    <ArrowForwardIcon sx={{ transform: i18n.language === 'ar' ? 'rotate(180deg)' : 'none' }} />
                  }
                ...
                <Button
                  ...
                  to="/products"
                  variant="text"
                  sx={{ textTransform: 'none', fontWeight: 600, color: 'primary.main', display: 'flex', gap: 1}}
                  endIcon={
                    <ArrowForwardIcon sx={{transform: i18n.language === 'ar' ? 'rotate(180deg)' : 'none'}} />
                  }
                >
